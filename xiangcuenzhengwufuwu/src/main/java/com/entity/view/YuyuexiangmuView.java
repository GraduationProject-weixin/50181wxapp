...
public class YuyuexiangmuView extends YuyuexiangmuEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 预约结果的值
		*/
		private String yuyuexiangmuYesnoValue;
	...
	public YuyuexiangmuView() {

	}

	public YuyuexiangmuView(YuyuexiangmuEntity yuyuexiangmuEntity) {
		try {
			BeanUtils.copyProperties(this, yuyuexiangmuEntity);
			...
			* 获取： 预约结果的值
			*/
			public String getYuyuexiangmuYesnoValue() {
				return yuyuexiangmuYesnoValue;
			}
			/**
			* 设置： 预约结果的值
			*/
			public void setYuyuexiangmuYesnoValue(String yuyuexiangmuYesnoValue) {
				this.yuyuexiangmuYesnoValue = yuyuexiangmuYesnoValue;
			}
